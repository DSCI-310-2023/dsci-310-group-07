...
```{r make-plot, echo=FALSE, fig.cap="Distribution of make", out.width="90%"}
...
```{r length-plot, echo=FALSE, fig.cap="Distribution of length and price vs length", out.width="90%"}
...
```{r width-plot, echo=FALSE, fig.cap="Distribution of width and price vs width", out.width="90%"}
...
```{r curb-weight-plot, echo=FALSE, fig.cap="Distribution of car weight and price vs weight", out.width="90%"}
...
```{r num-of-cylinders-plot, echo=FALSE, fig.cap="Distribution of number of cylinders", out.width="90%"}
...
```{r eg-size-plot, echo=FALSE, fig.cap="Distribution of engine size and price vs engine size", out.width="90%"}
...
```{r horse-power-plot, echo=FALSE, fig.cap="Distribution of horse power and price vs horse power", out.width="90%"}
...
```{r hw-mpg-plot, echo=FALSE, fig.cap="Distribution of highway mpg and Price vs highway mpg", out.width="90%"}
